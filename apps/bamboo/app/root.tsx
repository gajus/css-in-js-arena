...
// Tokens are declared as base/_osDark pairs, which Bamboo folds into
// light-dark(). That makes an explicit theme override just `color-scheme` on a
// subtree rather than a second copy of the palette.
const schemes = {
  system: css({ colorScheme: "light dark" }),
  light: css({ colorScheme: "light" }),
  dark: css({ colorScheme: "dark" }),
};
